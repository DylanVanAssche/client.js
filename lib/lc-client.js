var Planner = require('../../csa.js/lib/csa').BasicCSA,
  TimespanPlanner = require('../../csa.js/lib/csa').TimespanCSA,
...
Client.prototype.basicQuery = function (q, cb) {
